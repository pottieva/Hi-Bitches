...
<div class="page-bar">
            ...
            <h3 class="page-title">
            Infomation Center <small>规范信息</small>
            </h3>
                ...
                <div class="col-md-2">
                    <ul class="inbox-nav margin-bottom-10">
                        <li class="compose-btn">
                            ...
                            <i class="fa fa-edit"></i> 新添规范 </a>
                        </li>               
                        <li class="inbox active">
                            <a href="javascript:;" class="btn" data-title="Inbox" id='Inbox1'>
                            规范总数(<?php echo $norm_status['inbox'];?>) </a>
                            <b></b>
                        </li>                      
                        <li class="draft">
                            <a class="btn" href="javascript:;" data-title="Draft" id='Draft1'>
                           草稿箱 (<?php echo $norm_status['draft'];?>)</a>
                            <b></b>
                        </li>
                        <li class="trash">
                            <a class="btn" href="javascript:;" data-title="Trash" id="Trash1">
                           垃圾箱 (<?php echo $norm_status['trash'];?>)</a>
                            <b></b>
                        </li>
                    </ul>
                </div>
